  ...
  <div tw="max-w-7xl mx-auto py-3 px-3 sm:px-6 lg:px-8">
    <div tw="flex items-center justify-between flex-wrap">
      ...
      <div tw="order-3 mt-2 flex-shrink-0 w-full sm:order-2 sm:mt-0 sm:w-auto">
        <a href="/" tw="flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-indigo-600 bg-white hover:bg-indigo-50">
          Learn more
        </a>
      </div>
      <div tw="order-2 flex-shrink-0 sm:order-3 sm:ml-3">
        <button type="button" tw="-mr-1 flex p-2 rounded-md hover:bg-indigo-500 focus:outline-none focus:ring-2 focus:ring-white sm:-mr-2">
